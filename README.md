...
Benice is a tiny set of browser performance estimation tools inspired by [Dan Kaminsky's simple & genius "nice.js"](https://www.youtube.com/watch?v=9wx2TnaRSGs). It enables you to "be nice" to your surrounding hosting environment by running your non-essential logic only when the browser is estimated idle enough to handle it gracefully, thus prevents "hogging" resources, and slowing down fellow scripts.  
